...
create_query = '''Create table if not exists business_cards(Name varchar(100),
...
if selected == 'Home':
    ...
    if uploaded_file != None:
        ...
        with col1:
            ...
            if a:
                access.execute("INSERT INTO business_cards (name, designation, company, email, website, primary_no, secondary_no,address, pincode, image) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    with col1:
        access.execute('select name from business_cards')
        y = access.fetchall()
    ...
    if selected_mode == 'View':
        ...
        with col5:
            access.execute(f"select name, designation, company, email, website, primary_no, secondary_no,address, pincode from business_cards where name = '{selected_contact}'")
            y = access.fetchall()
